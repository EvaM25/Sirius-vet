  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="mb-[40px]">
        <p>
          «Ты навсегда в ответе за всех, кого приручил» : слова Антуана де Сент
          Экзюпери никогда не теряют актуальность.
        </p>
        <p>
          ...
          лечебных мероприятий. Наша клиника осуществляет свою практику с 2003
          года и накопила немалый опыт в лечебно — профилактической
          деятельности. Мы всегда стараемся сочетать в нашей деятельности знание
          и умение, терпение и аккуратность, благоразумие и осторожность,
        ...
        <p>
          ...
          Баррикад 128. Отличительной чертой нашей ветклиники является{" "}
          <strong>круглосуточная работа</strong>.
        </p>
      </div>
